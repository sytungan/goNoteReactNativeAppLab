...
class Home extends Component {
    ...
    bottomLoading = () => {
        return (
            <View>
                {this.props.notes.info.page <
                this.props.notes.info.totalPage ? (
        ...
        return (
            <View style={styles.parentView}>
                ...
                {this.props.notes.isError ? (
                    <Text
                        style={{ fontSize: 20, alignSelf: "center", top: 20 }}
                    >
                        Try Again Later!
                    </Text>
                ) : (
